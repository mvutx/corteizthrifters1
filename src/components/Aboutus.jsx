    ...
    >
      ...
      <div
        style={{
          ...
          height: "100%",
          background:
            "radial-gradient(circle at 20% 20%, rgba(0,255,204,0.08), transparent 40%), radial-gradient(circle at 80% 60%, rgba(255,0,255,0.08), transparent 40%)",
          zIndex: 0
        }}
      />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            STAY SANE • STAY SANE • STAY SANE • STAY SANE • STAY SANE •
          </div>
        </div>

        {/* 🔥 HERO */}
        <div className="text-center mb-5">
          <h1 style={{ fontSize: "3rem", letterSpacing: "4px" }}>
            SACRED VANITY
          </h1>
        ...
        <div className="text-center mb-5">
          ...
          <p style={{ color: "#aaa", maxWidth: "700px", margin: "auto" }}>
            It represents protecting your mind in a chaotic world. Staying grounded,
            focused, and true to yourself while everything around you tries to
            distract, pressure, or break you.
          </p>

          <p style={{ color: "#aaa", maxWidth: "700px", margin: "auto" }}>
            It’s about choosing clarity over chaos. Discipline over noise. Identity
            over influence.
          </p>
        </div>
        ...
        <div className="text-center mb-5">
          ...
          <p style={{ color: "#aaa", maxWidth: "700px", margin: "auto" }}>
            In a world driven by screens, algorithms, and endless scrolling — we
            create pieces that remind you to stay real.
          </p>
        ...
        >
          <h2 style={{ color: "#00ffcc", letterSpacing: "2px" }}>
